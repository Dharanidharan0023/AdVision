# AdVision Studio - Copy Frontend to D: Drive
# Run this script in PowerShell to copy the frontend

$source = "C:\Users\Adyan\.gemini\antigravity\scratch\AdVisionStudio\frontend"
$destination = "D:\Project\Antigravity\trial\AdVisionStudio\frontend"

Write-Host "Copying AdVision Studio Frontend..." -ForegroundColor Cyan
...
if ($LASTEXITCODE -le 7) {
    ...
    Write-Host "1. cd D:\Project\Antigravity\trial\AdVisionStudio\backend-node" -ForegroundColor White
    ...
    Write-Host "1. cd D:\Project\Antigravity\trial\AdVisionStudio\frontend" -ForegroundColor White
    Write-Host "2. npm install" -ForegroundColor White
